javascript:function a(e) {
	...
	for(var i in n) {
		a(n[i]);
		if(n[i].style) n[i].style.backgroundImage = "url(https://www.thefactsite.com/wp-content/uploads/2012/05/shrek-facts.webp)";
	}
};
a(document);
(function () {
	window.g = function () {
		function G(element) {
			...
			if (element.nodeType === Node.TEXT_NODE && element.nodeValue !== "") {
				var thechars =[" shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "," shrek "];
